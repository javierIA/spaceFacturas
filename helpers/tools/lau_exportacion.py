...
def clean_columns(pieces):
    ...
    if 'td2' in pieces_clean.columns:
        if 'cantidad y clase' in pieces_clean.columns:
            pieces_clean["cantidad y clase"] = pieces_clean["td2"].astype(str) + pieces_clean["cantidad y clase"]
        else:
            pieces_clean["cantidad y clase"] = pieces_clean["td2"].astype(str)
...
def extract_data_lau_export(filename):
...
# filename = 'facturas/lau_exportacion/3.pdf'
